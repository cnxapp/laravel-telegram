...
final class SendVideoNoteRequest extends Request
{
    protected const METHOD = 'sendVideoNote';
    ...
    protected const FIELDS = [
        ...
        'video_note' => ['property' => 'videoNote', 'type' => 'InputFile or String', 'optional' => false],
        'duration' => ['property' => 'duration', 'type' => 'Integer', 'optional' => true],
        'length' => ['property' => 'length', 'type' => 'Integer', 'optional' => true],
