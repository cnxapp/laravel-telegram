...
use Carbon\Carbon;
use Cnx\LaravelTelegram\Enums\ChatMemberStatus;
...
class ChatMember extends Data
{
     ...
     * @param  bool|Optional  $canAddWebPagePreviews  For type "restricted": True, if the user is allowed to add web page previews to their messages
    ...
    public function __construct(
        ...
        public bool|Optional $canAddWebPagePreviews,
