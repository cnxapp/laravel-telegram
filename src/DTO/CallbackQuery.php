...
class CallbackQuery extends Data
{
     ...
     * @param  Message|InaccessibleMessage|Optional  $message  Optional. Message sent by the bot with the callback button that originated the query
    ...
    public function __construct(
        public string $id,
        public User $from,
        public Message|InaccessibleMessage|Optional $message,
