...
class Message extends Data
{
     ...
     * @param  LivePhoto|Optional  $livePhoto  Optional. Message is a live photo.
     * @param  PaidMediaInfo|Optional  $paidMedia  Optional. Message contains paid media.
     ...
     * @param  RefundedPayment|Optional  $refundedPayment  Optional. Message is a service message about a refunded payment.
     ...
     * @param  ForumTopicClosed|Optional  $forumTopicClosed  Optional. Empty object. Service message: forum topic closed
     * @param  ForumTopicReopened|Optional  $forumTopicReopened  Optional. Empty object. Service message: forum topic reopened
     * @param  GeneralForumTopicHidden|Optional  $generalForumTopicHidden  Optional. Empty object. Service message: the 'General' forum topic hidden
     * @param  GeneralForumTopicUnhidden|Optional  $generalForumTopicUnhidden  Optional. Empty object. Service message: the 'General' forum topic unhidden
     * @param  GiveawayCreated|Optional  $giveawayCreated  Optional. Service message: a scheduled giveaway was created
     ...
     * @param  VideoChatStarted|Optional  $videoChatStarted  Optional. Empty object. Service message: video chat started
    ...
    public function __construct(
        ...
        public PaidMediaInfo|Optional $paidMedia,
        ...
        public RefundedPayment|Optional $refundedPayment,
        ...
        public ForumTopicClosed|Optional $forumTopicClosed,
        public ForumTopicReopened|Optional $forumTopicReopened,
        public GeneralForumTopicHidden|Optional $generalForumTopicHidden,
        public GeneralForumTopicUnhidden|Optional $generalForumTopicUnhidden,
        public GiveawayCreated|Optional $giveawayCreated,
        ...
        public VideoChatStarted|Optional $videoChatStarted,
