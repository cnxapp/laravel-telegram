...
class Update extends Data
{
     ...
     * @param  Message|Optional  $guestMessage  Optional. New guest message.
     ...
     * @param  PaidMediaPurchased|Optional  $purchasedPaidMedia  Optional. A user purchased paid media sent by the bot.
     ...
     * @param  ChatBoostRemoved|Optional  $removedChatBoost  Optional. A boost was removed from a chat. The bot must be an administrator in the chat to receive these updates.
     * @param  ManagedBotUpdated|Optional  $managedBot  Optional. A managed bot was created or updated.
     * @param  BotSubscriptionUpdated|Optional  $subscription  Optional. A user payment subscription changed.
     */
    public function __construct(
        ...
        public Message|Optional $guestMessage,
        ...
        public PaidMediaPurchased|Optional $purchasedPaidMedia,
        ...
        public ChatBoostRemoved|Optional $removedChatBoost,
        public ManagedBotUpdated|Optional $managedBot,
        public BotSubscriptionUpdated|Optional $subscription,
    ) {}
